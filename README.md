...
## 🚀 Google Cloud Deployment Steps (Production Guide)
...
### Phase 3: Deployment via Cloud SDK (Windows)
...
**Live Infrastructure:** [https://project-setu-32372428108.asia-south1.run.app](https://project-setu-32372428108.asia-south1.run.app)
...
---
**Developed for the Google Cloud Societal Benefit Challenge.**
```
